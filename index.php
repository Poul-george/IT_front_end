...
if (isset($_POST["answer_send"])) {
  if ($_POST["answer_send"] === "結果を送信") {
    if (count($_POST) === 0 || count($_POST) <= 15) {
      // echo "<script>alert('回答されていない項目があります！');</script>";
      header("Location: http://co-19-246.99sv-coco.com/IT_front_end/no_kaitou.php");
      // header("Location: http://co-19-246.99sv-coco.com/no_kaitou.php");
      exit;
    } elseif (count($_POST) === 16) {
      $_SESSION["array"] = $_POST;
      $_SESSION["kaitou_end"] = "end";
      header("Location: http://co-19-246.99sv-coco.com/IT_front_end/kaitou.php");
      // header("Location: http://co-19-246.99sv-coco.com/kaitou.php");
      exit;
    }
  }
}
...
if (isset($_POST["returu"])) {
  if ($_POST["returu"] === "終了する") {
    $_SESSION["kaitou_end"] = "";
    $_SESSION["array"] = "";
    header("Location: http://co-19-246.99sv-coco.com/IT_front_end/index.php");
    // header("Location: http://co-19-246.99sv-coco.com/index.php");
    exit;
  }
}
...
<?php if ($_SESSION["kaitou_end"] === "" || $_SESSION["kaitou_end"] === NULL ) { ?>
  <body  style="background-color:#EEFFFF;">
    <div class="all">
        ...
        <div class="use">
            <p>使用法</p>
            <ul>
                <li>Q1〜Q15の質問に答え、結果を送信を押してください！
            (全ての質問に回答するようにお願いします)</li>
        ...
        <div class="main">
            <form method="post" action="http://co-19-246.99sv-coco.com/IT_front_end/index.php" name="form" onsubmit="return formCheck()">
                ...
                <div class="submit">
                    <input type="submit" name="answer_send" value="結果を送信">
                    <br><br>
                </div>
            </form> 
        </div>
    ...
    <?php } elseif ($_SESSION["kaitou_end"] === "end") { ?>
      <h2>回答されています！</h2>
      <a href="http://co-19-246.99sv-coco.com/IT_front_end/kaitou.php">前のページへ</a>
    <?php } ?>
